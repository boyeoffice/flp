...
<nav class="navbar navbar-default navbar-static-top">
        ...
        <ul class="nav nav-pills nav-justified">
              <li role="presentation" class="active"><a href="{{url('home')}}"><i class="glyphicon glyphicon-home"></i> Home</a></li>
              <li role="presentation"><a href='{{url('home/pages')}}'><i class="glyphicon glyphicon-th-large"></i>  Pages</a>
              </li>
